...
KeyboardToolsKayoko_FILES = Tweak.xm KTClipboardManager.m KTClipboardViewController.m KTDebugLogger.m
KeyboardToolsKayoko_CFLAGS = -fobjc-arc
KeyboardToolsKayoko_FRAMEWORKS = UIKit Foundation

BUNDLE_NAME = KeyboardToolsKayokoPrefs

KeyboardToolsKayokoPrefs_FILES = KTKPrefsRootListController.m KTDebugViewController.m KTDebugLogger.m
