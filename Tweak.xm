...
static CGRect KTClipboardPanelFrame;
...
static void KTClipboardOpen(void) {
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        CGFloat height = floor(screenHeight * 0.40);
        CGFloat x = 0.0;
        ...
        KTClipboardPanelFrame = CGRectMake(x, y, width, height);

        page.view.frame = CGRectMake(x, screenHeight + 20.0, width, height);
        page.view.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleTopMargin;
        ...
        [UIView animateWithDuration:0.24
                         ...
                         animations:^{
            page.view.frame = KTClipboardPanelFrame;
        }
                         completion:nil];
    });
}
